...
title: 'Théorie des Cordes : La Symphonie Mathématique de l''Univers'
authors: [professor_manus]
tags: [théorie-cordes, physique-théorique, géométrie, mathématiques]
---
...
```mermaid
graph TD
    A["Physique Classique<br/>Newton, Maxwell"] --> B["Relativité Restreinte<br/>Einstein 1905"]
    B --> C["Mécanique Quantique<br/>Planck, Bohr, Schrödinger"]
    C --> D["Relativité Générale<br/>Einstein 1915"]
    D --> E["Théorie Quantique<br/>des Champs"]
    E --> F["Modèle Standard<br/>Particules & Forces"]
    F --> G["Théorie des Cordes<br/>Unification"]
    G --> H["M-Théorie<br/>11 Dimensions"]
...
- **Introduction aux cordes** : [Introduction à la Théorie des Cordes](/docs/theory/intro_cordes)
- **Variétés de Calabi-Yau** : [Variétés de Calabi-Yau](/docs/theory/calabi_yau)
- **M-théorie et dualités** : [Dualités et M-Théorie](/docs/theory/dualites_m_theorie)
- **Notebooks pratiques** : [Théorie des Cordes](https://github.com/Axle-Bucamp/docausorusTopologieExplained/tree/main/docs/notebooks/07_string_theory.ipynb)
