...
title: 'P vs NP : Le Problème du Millénaire qui Défie les Mathématiciens'
authors: [maitre_complexite]
tags: [complexité, algorithmes, P-vs-NP, théorie-computationnelle]
---
...
```mermaid
graph TD
    A["Tous les Problèmes<br/>Calculables"] --> B["P<br/>Temps Polynomial<br/>Déterministe"]
    A --> C["NP<br/>Temps Polynomial<br/>Non-déterministe"]
    A --> D["Co-NP<br/>Complémentaires<br/>de NP"]
    A --> E["PSPACE<br/>Espace Polynomial"]
    A --> F["EXPTIME<br/>Temps Exponentiel"]
    
    B --> G["P ⊆ NP<br/>Inclusion évidente"]
    C --> H["P = NP ?<br/>Question ouverte"]
    C --> I["P ≠ NP ?<br/>Hypothèse probable"]
...
- **Théorie complète** : [Fondements de la Complexité](/docs/theory/complexite_fondements)
- **P vs NP détaillé** : [P vs NP](/docs/theory/p_vs_np)
- **Algorithmes d'approximation** : [Approximation et Heuristiques](/docs/theory/approximation_heuristiques)
- **Notebooks pratiques** : [Complexité P vs NP](https://github.com/Axle-Bucamp/docausorusTopologieExplained/tree/main/docs/notebooks/04_p_vs_np_complexite.ipynb)
