...
title: 'Manifold Learning : Explorer les Dimensions Cachées de vos Données'
authors: [professor_manus]
tags: [manifold-learning, embeddings, réduction-dimension, machine-learning]
---
...
```mermaid
graph TD
    A["Données Haute Dimension<br/>ℝᵈ (d > 3)"] --> B["Variété Sous-jacente<br/>ℝᵏ (k << d)"]
    B --> C["Coordonnées Locales<br/>Paramétrage"]
    B --> D["Métrique Riemannienne<br/>Distances Locales"]
    B --> E["Projection Linéaire<br/>PCA, LDA"]
    B --> F["Projection Non-linéaire<br/>t-SNE, UMAP"]
    
    C --> G["Embeddings<br/>Représentation Compacte"]
    D --> G
    E --> G
    F --> G
...
- **Théorie complète** : [Manifold Learning](/docs/theory/20_manifold_learning)
- **Word Embeddings** : [Word Embeddings](/docs/theory/21_word_embeddings)
- **Graph Embeddings** : [Graph Embeddings & GDL](/docs/theory/22_graph_embeddings_gdl)
- **Notebooks pratiques** : [Embeddings & ML](/docs/notebooks/06_embeddings_ml)
