...
- **Cours complet** : [Topological Data Analysis](/docs/theory/15_topological_data_analysis)
- **Applications** : [TDA Applications](/docs/theory/16_tda_applications)
- **Notebooks** : [Exemples pratiques](/docs/notebooks/05_tda_homologie)
